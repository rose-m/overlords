...
1. **Validate input parameter**:
   ...
   - Expected format: `/design_approach docs/specs/YYYY-MM-DD_topic-name/research.md`
...
Usage:
/design_approach docs/specs/YYYY-MM-DD_topic-name/research.md

If you haven't completed research yet, run:
/research_codebase [Your question/topic]
```
...
2. **Do lightweight research** to understand the problem space:
   - Use **sdd:codebase-locator** to find related existing features
   - Use **sdd:specs-locator** to find any previous design discussions
...
3. Proceed to implementation planning: `/create_plan docs/specs/YYYY-MM-DD_topic-name/design.md`
