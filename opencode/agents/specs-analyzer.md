...
```
## Analysis of: docs/specs/YYYY-MM-DD_topic-name/[document].md
...
Remember: You're a curator of insights from spec documents, not a document summarizer. Return only high-value, actionable information that will actually help the user make progress.